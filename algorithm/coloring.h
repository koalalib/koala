    ...
    class SeqVertColoring
    {
      protected:
        ...
        template< typename Graph, typename ColorMap, typename CompMap >
            static int interchangeComponents( const Graph &g, ColorMap &c, typename Graph::PVertex v, CompMap &map,
                int c1, int c2 );

        template< typename Graph, typename ColorMap >
            static int colorInterchange( const Graph &g, ColorMap &c, typename Graph::PVertex v );

        template< typename Graph, typename ColorMap > static int maxColor( const Graph &g, ColorMap &c );
      ...
      public:
        ...
        template< typename Graph, typename ColorMap >
            static int greedyInter( const Graph &g, ColorMap &c, typename Graph::PVertex v, int l );
        ...
        template< typename Graph, typename ColorMap, typename Iterator >
            static int greedyInter( const Graph &g, ColorMap &c, Iterator b, Iterator e );

        // Kolorowanie podanego zakresu wierzchołków (z zamianą kolorów).
        template< typename Graph, typename ColorMap, typename Iterator >
            static int greedyInter( const Graph &g, ColorMap &c, Iterator b, Iterator e, int l );
        ...
        // (z zamianą kolorów).
        template < typename Graph, typename ColorMap, typename Iterator >
            static int lfInter( const Graph &g, ColorMap &c , Iterator b, Iterator e );

        // Kolorowanie podanego zakresu wierzchołków, metoda Largest First
        // (z zamianą kolorów).
        template < typename Graph, typename ColorMap, typename Iterator >
            static int lfInter( const Graph &g, ColorMap &c , Iterator b, Iterator e, int l );
        ...
        // (z zamianą kolorów).
        template < typename Graph, typename ColorMap, typename Iterator >
            static int slInter( const Graph &g, ColorMap &c , Iterator b, Iterator e );

        // Kolorowanie podanego zakresu wierzchołków, metoda Smallest Last
        // (z zamianą kolorów).
        template < typename Graph, typename ColorMap, typename Iterator >
            static int slInter( const Graph &g, ColorMap &c , Iterator b, Iterator e, int l );
        ...
        // (z zamianą kolorów).
        template < typename Graph, typename ColorMap, typename Iterator >
            static int slfInter( const Graph &g, ColorMap &c , Iterator b, Iterator e );

        // Kolorowanie podanego zakresu wierzchołków, metoda Saturation Largest First
        // (z zamianą kolorów).
        template < typename Graph, typename ColorMap, typename Iterator >
            static int slfInter( const Graph &g, ColorMap &c , Iterator b, Iterator e, int l );
    };
