...
int main() {
	...
	TestData data[] = {
		...
		{ 5, "10 0 2 -1 -2 1 2 -3 -9 2 1 -4 3 2 -5 -6 4 1 -7 5 1 -6 6 2 -7 -8 7 1 -8 8 0 9 0"},
		{ 9, "18 0 4 -17 -8 -13 -4 1 1 -15 2 3 -9 -12 -3 3 3 -15 -7 -9 4 1 -9 5 2 -9 -14 6 2 -8 -17 7 2 -11 -10 8 2 -12 -17 9 3 -15 -10 -13 10 2 -12 -16 11 1 -12 12 0 13 0 14 2 -17 -16 15 0 16 0 17 0"},
...
//		if(i == 4) __debugbreak();
		...
		if(n != data[i].size) {
			...
			fail = true;
		} else if(!Matching::test(g, edges, edges + n)) {
			printf("test %d FAILED matching::test\n", i);
			fail = true;
		} else {
			printf("test %d ok\n", i);
			};
