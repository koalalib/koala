...
/*/SLOW*/	Connect::minEdgeCut(g, edgeList.begin());
...
/**/		fprintf(stderr, "\r%3d %5d 27", n, m);
		vmap.clear();
/**/		z += SeqVertColoring::lf(g, vmap);
/**/		fprintf(stderr, "\r%3d %5d 28", n, m);
		vmap.clear();
/**/		z += SeqVertColoring::lfInter(g, vmap);
/**/		fprintf(stderr, "\r%3d %5d 29", n, m);
		vmap.clear();
/**/		z += SeqVertColoring::sl(g, vmap);
/**/		fprintf(stderr, "\r%3d %5d 30", n, m);
		vmap.clear();
/**/		z += SeqVertColoring::slInter(g, vmap);
/**/		fprintf(stderr, "\r%3d %5d 31", n, m);
		vmap.clear();
/**/		z += SeqVertColoring::slf(g, vmap);
/**/		fprintf(stderr, "\r%3d %5d 32", n, m);
		vmap.clear();
/**/		z += SeqVertColoring::slfInter(g, vmap);
		...
		vmap.clear();
/**/		z += SeqEdgeColoring::vizing(g, emap);
...
/*/SLOW*/		z += Flow::minEdgeCut(g, flowEdgeCont, Flow::outCut(blackHole, edgeList.begin())).capac;
