...
int misChordal_SimpleOut(const char* g6)
{
    MyGraph g;
    g.makeAdjMatrix();
    Set<MyGraph::PVertex> res;
...
int cliqueChordal_SimpleOut(const char* g6)
{
    MyGraph g;
    g.makeAdjMatrix();
    Set<MyGraph::PVertex> res;
...
int misComparability_SimpleOut(const char* g6)
{
    MyGraph g;
    g.makeAdjMatrix();
    Set<MyGraph::PVertex> res;
...
int cliqueComparability_SimpleOut(const char* g6)
{
    MyGraph g;
    g.makeAdjMatrix();
    Set<MyGraph::PVertex> res;
...
int matching(const char* g6)
{
    ...
    assert(res>=0 && MatchingPar< Settings >::test(g,tabe,tabe+res));
    cout << '{';
    for(int i=0;i<res;i++)
    {
        cout << '{';
...
int matching_SimpleOut(const char* g6)
{
    MyGraph g;
    g.makeAdjMatrix();
    IO::readG6(g,g6);
...
//    catch(Koala::Error::ContExcEmpty &ex) { std::cerr << "\n\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\nBlad!!!\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\nTyp: " << ex.type() <<"\nPlik: " <<ex.file() <<"\nWiersz: "<< ex.line() <<"\nZlamano warunek: "<<ex.descr() <<"\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";}
    return 0;
}
