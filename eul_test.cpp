...
int main() {
    ...
    std::cout <<"C:"<< Koala::Euler::hasCycle(g,mask)<<std::endl;
    std::cout<<"P:"<< Koala::Euler::hasPath(g,mask)<<std::endl;

    std::cout << "\n\n\n";


        std::cout<< "C:" << Koala::Euler::getCycle(g,C,Koala::Euler::outPath(tabV,tabE),mask)<<std::endl;
        ...
        std::cout<< "\n\nP:" <<Koala::Euler::getPath(g,A,Koala::Euler::outPath(tabV,tabE),mask)<<std::endl;
        for(int i=0;tabV[i];i++) std::cout<< tabV[i]->info.name; std::cout<< std::endl;
        for(int i=0;tabE[i];i++) std::cout<< "{"<< g.getEdgeEnds(tabE[i]).first->info.name <<
                            "," << g.getEdgeEnds(tabE[i]).second->info.name << "}";
        std::cout<< std::endl;
