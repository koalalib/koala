...
Koala::Graph<OpisV,OpisE>::PVertex A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,tabV[11];
...
int main() {
    ...
    int matchSize = Koala::Matching::find (g,vertCont,tabE,-1);
    ...
    matchSize = Koala::Matching::find (g,vertCont,tabE,3);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;
    std::cout<< "Znalezione skojarzenie-strumien krawedzi nalezacych do skojarzenia" << std::endl;
    for(int i=0;i<matchSize;i++) std::cout<< "{"<< g.getEdgeEnds(tabE[i]).first->info.name <<
                            "," << g.getEdgeEnds(tabE[i]).second->info.name << "}\n";
    ...
    matchSize = Koala::Matching::find (g,vertCont,blackHole,4);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;

    edmTest();
    std::cout<< "\n4. Teraz chcemy skojarzenie rozmiaru 10.\n";
    matchSize = Koala::Matching::find (g,vertCont,blackHole,10);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;
    ...
    matchSize = Koala::Matching::find (g,vertCont,tab.begin(),tab.end(),tabE,10);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;
    std::cout<< "Znalezione skojarzenie-strumien krawedzi nalezacych do skojarzenia" << std::endl;
    for(int i=0;i<matchSize;i++) std::cout<< "{"<< g.getEdgeEnds(tabE[i]).first->info.name <<
                            "," << g.getEdgeEnds(tabE[i]).second->info.name << "}\n";
    ...
    matchSize = Koala::Matching::find (g,vertCont,tab0.begin(),tab0.end(),tabE,3);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;
    std::cout<< "Znalezione skojarzenie-strumien krawedzi nalezacych do skojarzenia" << std::endl;
    for(int i=0;i<matchSize;i++) std::cout<< "{"<< g.getEdgeEnds(tabE[i]).first->info.name <<
                            "," << g.getEdgeEnds(tabE[i]).second->info.name << "}\n";
    ...
    matchSize = Koala::Matching::find (g,vertCont,tab1.begin(),tab1.end(),tabE,-1);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;
    std::cout<< "Znalezione skojarzenie-strumien krawedzi nalezacych do skojarzenia" << std::endl;
    for(int i=0;i<matchSize;i++) std::cout<< "{"<< g.getEdgeEnds(tabE[i]).first->info.name <<
                            "," << g.getEdgeEnds(tabE[i]).second->info.name << "}\n";
    ...
    matchSize = Koala::Matching::find (g,vertCont,tab3.begin(),tab3.end(),tabE,4);
    std::cout<< "Rozmiar znalezionego skojarzenia: " << matchSize << std::endl;
    std::cout<< "Znalezione skojarzenie-strumien krawedzi nalezacych do skojarzenia" << std::endl;
    for(int i=0;i<matchSize;i++) std::cout<< "{"<< g.getEdgeEnds(tabE[i]).first->info.name <<
                            "," << g.getEdgeEnds(tabE[i]).second->info.name << "}\n";
    ...
    edmTest2();
    std::cout<< "\n1a. Chcemy skojarzenie maksymalne.\n";
    matchSize = Koala::Matching::find (g,vertCont,tabE,-1);
    ...
    int edgeCoverSize = Koala::Matching::minEdgeCover (g,vertCont,tabE);
